...
<div id="confirm-overlay">
    <div id="confirm-box">
        <div class="flex items-start gap-3 mb-5">
            <div id="confirm-icon" class="w-8 h-8 rounded-lg flex items-center justify-center shrink-0"
                 style="background:rgba(185,28,28,0.09);color:var(--danger);">
            ...
            <div class="min-w-0">
                <h3 id="confirm-title" class="text-[14px] font-semibold leading-tight" style="color:var(--text)">Are you sure?</h3>
                <p id="confirm-msg" class="text-[12.5px] mt-1 leading-relaxed" style="color:var(--text-muted)">This action cannot be undone.</p>
            </div>
        </div>
        <div class="flex gap-2 justify-end">
            <button onclick="closeConfirm()" class="btn-ghost">Cancel</button>
            <a id="confirm-action-btn" href="#" class="btn-danger">Delete</a>
        </div>
    </div>
</div>
