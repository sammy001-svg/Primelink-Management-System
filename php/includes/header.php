...
<body class="bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 min-h-screen font-sans antialiased selection:bg-amber-300/30">
...
<div class="mobile-drawer" id="mobileDrawer" onclick="closeMobileDrawer(event)">
    ...
    <div class="drawer-panel" id="drawerPanel">
        <div class="flex items-center gap-3 mb-8 px-2">
            <div class="w-10 h-10 bg-accent-gold rounded-xl flex items-center justify-center text-slate-900 shadow-lg">
