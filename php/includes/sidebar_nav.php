...
// ─── ADMIN / STAFF ────────────────────────────────────────
    ...
    $addSubLink($finSubs, 'bank_accounts.php',    'Collection Accounts',     'bank_accounts');
    ...
    $addLink($adLinks, ['href' => 'leave.php',    'label' => 'Leave Management',   'module' => 'leave',     'icon' => '<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/><path d="M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01"/></svg>']);
    $addLink($adLinks, ['href' => 'corrections_register.php', 'label' => 'Corrections Register', 'module' => 'invoices', 'icon' => '<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="m9 15 2 2 4-4"/></svg>']);
    $addLink($adLinks, ['href' => 'sms_log.php', 'label' => 'SMS Log', 'module' => 'invoices', 'icon' => '<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>']);
    // Admin-only links
    if ($_isAdmin) {
